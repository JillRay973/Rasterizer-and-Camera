...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_Escape : on_actionQuit_Esc_triggered(); rasterizer.RenderScene(); break;
    ...
    case Qt::Key_Up : rasterizer.camera.rotatecamx(-5); rasterizer.RenderScene();break;
    case Qt::Key_Down : rasterizer.camera.rotatecamx(5); rasterizer.RenderScene();break;
    case Qt::Key_Left : rasterizer.camera.rotatecamy(5); rasterizer.RenderScene();break;
    case Qt::Key_Right : rasterizer.camera.rotatecamy(-5); rasterizer.RenderScene();break;
    case Qt::Key_Z : rasterizer.camera.rotatecamz(5);rasterizer.RenderScene(); break;
    case Qt::Key_X : rasterizer.camera.rotatecamz(-5); rasterizer.RenderScene();break;
